...
/*IDENTIFICAMOS ID PARA ACTULIZAR IMAGEN*/
/*
$sql="SELECT MAX(id) AS mayor FROM slider";
$sql_last = mysqli_query($con,$sql);
...
$rw=mysqli_fetch_array($sql_last);
$idSlide=$rw['last'];
//$idSlide=mysqli_insert_id($con);
/* fin de "IDENTIFICAMOS ID PARA ACTULIZAR IMAGEN"*/
...
// if everything is ok, try to upload file
    ...
    if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_file)) {
	 ...
	 $update=mysqli_query($con,"UPDATE slider SET url_image='$ruta' WHERE id='$idSlide'");
