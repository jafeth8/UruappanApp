...
$target_dir = "../img/imageNegocios/imagenPrincipal/";
$carpeta=$target_dir;
...
if (file_exists($target_file)) {
	//unlink("../img/imageNegocios/imagenPrincipal/".$_FILES["fileToUpload"]["name"]);
...
// if everything is ok, try to upload file
    ...
    if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_file)) {
	 ...
	 $update=mysqli_query($con,"UPDATE socios SET url_imagen_principal='$ruta' WHERE id_socio='$id_socio'");
